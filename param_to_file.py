...
def do_restart():
    ...
    node.request(request, nodeid, callback, priority=REQUEST_PRIORITY, timeout=5000.0)


def do_execute_opcode(opcode):
...
try:
    ...
    if args.node_id is not None:
        ...
        try:
            ...
            if e.errno == 100:
                print("Network is down. Please check your CAN interface work only with can0.")
                sys.exit(1)
            else:
                raise
    ...
    if args.mode == "write":
        ...
        while True:
            ...
            if not diff_dict:
                ...
                do_execute_opcode(opcodes.OPCODE_SAVE)
